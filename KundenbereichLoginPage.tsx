...
export const KundenbereichLoginPage: React.FC<KundenbereichLoginPageProps> = React.memo(({ onNavigate }) => {
  ...
  // Memoize background style to prevent recalculations
  ...
  return (
    <div className="min-h-screen overflow-x-hidden relative" style={{ backgroundColor: '#0E0F1A' }}>
      ...
      {/* Floating background elements - optimized animations */}
      <div className="absolute top-20 left-4 sm:left-10 w-24 sm:w-32 h-24 sm:h-32 bg-[#FF3F87]/10 rounded-full blur-2xl opacity-60" />
      <div className="absolute top-40 right-4 sm:right-16 w-20 sm:w-24 h-20 sm:h-24 bg-[#00D0C0]/10 rounded-full blur-2xl opacity-60" />
      <div className="absolute bottom-32 left-4 sm:left-20 w-32 sm:w-40 h-32 sm:h-40 bg-[#A020F0]/8 rounded-full blur-3xl opacity-60" />
                ...
                <Card variant="glass" className="glow-pink">
                  <CardContent className="p-6 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      <Button variant="secondary" size="sm" className="flex-1 button-safe" type="button">
...
KundenbereichLoginPage.displayName = 'KundenbereichLoginPage';